...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println();
        printCiftVeKucukOtuzDort(sayi);

        System.out.println();
        printCiftVeyaBuyukOtuzDort(sayi);
    ...
    public static void printCiftVeKucukOtuzDort(List<Integer> sayi){
    ...
    public static void printCiftVeyaBuyukOtuzDort(List<Integer> sayi){
